...
const DetailPage = () => {
  ...
  return (
    <div className='min-h-screen flex-col  justify-center items-center w-[1000px] mx-auto py-16 relative '>
      <div className='absolute right-0'>
        <UpdateModal bookData={bookData} />
      </div>
      <div className='flex items-center gap-4 mb-4 '>
        <h2 className='font-bold text-[28px] '>{bookData.book_name}</h2>
      ...
      <div className='flex justify-center gap-12'>
        ...
        <div className='w-[700px] h-[600px] flex flex-col bg-slate-200 p-8 gap-4'>
